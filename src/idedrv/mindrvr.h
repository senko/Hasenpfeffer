...
#define SYSTEM_TIMER_TICKS_PER_SECOND  1000L
...
// #define TMR_TIME_OUT 20 // Too big
#define TMR_TIME_OUT 2 // better
...
extern int reg_info(unsigned char devNum, char *size);
